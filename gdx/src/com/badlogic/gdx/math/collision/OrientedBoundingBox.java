...
public class OrientedBoundingBox implements Serializable {
    ...
    public boolean contains(BoundingBox b) {
        ...
        return contains(b.getCorner000(tmpVector), inverseTransform) && contains(b.getCorner001(tmpVector), inverseTransform) && contains(b.getCorner010(tmpVector), inverseTransform) && contains(b.getCorner011(tmpVector), inverseTransform) && contains(b.getCorner100(tmpVector), inverseTransform) && contains(b.getCorner101(tmpVector), inverseTransform) && contains(b.getCorner110(tmpVector), inverseTransform) && contains(b.getCorner111(tmpVector), inverseTransform);
    }
    ...
    public boolean contains(OrientedBoundingBox obb) {
        return contains(obb.getCorner000(tmpVectors[0]), inverseTransform) && contains(obb.getCorner001(tmpVectors[0]), inverseTransform) && contains(obb.getCorner010(tmpVectors[0]), inverseTransform) && contains(obb.getCorner011(tmpVectors[0]), inverseTransform) && contains(obb.getCorner100(tmpVectors[0]), inverseTransform) && contains(obb.getCorner101(tmpVectors[0]), inverseTransform) && contains(obb.getCorner110(tmpVectors[0]), inverseTransform) && contains(obb.getCorner111(tmpVectors[0]), inverseTransform);
    }
