 ...
 */
public class GroupTest extends GdxTestKotlin {
    Stage stage;
    SpriteBatch batch;
    BitmapFont font;
...
// vertWrap.setWidth(vertWrap.getPrefWidth());
    ...
    class TestGroup extends Group {
        ...
        public void draw(Batch batch, float parentAlpha) {
            ...
            toScreenCoordinates.set(testX, testY).sub(getOriginX(), getOriginY()).scl(getScaleX(), getScaleY()).rotateDeg(getRotation()).add(getOriginX(), getOriginY()).add(getX(), getY());
