...
public class CustomShadingPanel extends EditorPanel {
    ...
    public CustomShadingPanel(final ParticleEditor editor, String name, String description) {
...

        {
            ...
            contentPanel.add(shaderStagePanel, new GridBagConstraints(0, 0, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        }

        {
            JPanel shaderStagePanel = createShaderStagePanel(editor, contentPanel, false);
            contentPanel.add(shaderStagePanel, new GridBagConstraints(1, 0, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
        }

        {
            imagesPanel = new JPanel(new GridBagLayout());
            contentPanel.add(imagesPanel, new GridBagConstraints(2, 0, 1, 1, 1, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
            ...
            imagesPanel.add(imageList, new GridBagConstraints(0, 1, 1, 4, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

            JButton addButton = new JButton("Add");
            imagesPanel.add(addButton, new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
            ...
            imagesPanel.add(upButton, new GridBagConstraints(1, 2, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
            ...
            imagesPanel.add(downButton, new GridBagConstraints(1, 3, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
            ...
            imagesPanel.add(removeButton, new GridBagConstraints(1, 4, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
            ...
            imagesPanel.add(reloadButton, new GridBagConstraints(1, 5, 1, 1, 0, 0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    ...
    private JPanel createShaderStagePanel(final ParticleEditor editor, JPanel contentPanel, final boolean isVertexShader) {
        ...
        setButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                FileDialog dialog = new FileDialog(editor, isVertexShader ? "Open Vertex Shader File" : "Open Fragment Shader File", FileDialog.LOAD);
                if (lastDir != null) dialog.setDirectory(lastDir);
                dialog.setVisible(true);
                final String file = dialog.getFile();
                final String dir = dialog.getDirectory();
        ...
        showButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                JOptionPane.showMessageDialog(editor, text, isVertexShader ? "Current vertex shader code" : "Current fragment shader code", JOptionPane.INFORMATION_MESSAGE);
            }
        });
    ...
    protected void displayErrors() {
        if (shading.hasShaderErrors) {
            ...
            JOptionPane.showMessageDialog(editor, shading.missingSamplerMessage, "Missing texture sampler", JOptionPane.WARNING_MESSAGE);
        }
    }
