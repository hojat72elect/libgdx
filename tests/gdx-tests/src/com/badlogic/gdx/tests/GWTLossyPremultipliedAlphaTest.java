 ...
 * @author barkholt
 */
public class GWTLossyPremultipliedAlphaTest extends GdxTestK {
    ...
    public void render() {
        ...
        batch.draw(goodTexture, Gdx.graphics.getWidth() * 0.5f, Gdx.graphics.getHeight(), Gdx.graphics.getWidth() * 0.5f, -Gdx.graphics.getHeight());
