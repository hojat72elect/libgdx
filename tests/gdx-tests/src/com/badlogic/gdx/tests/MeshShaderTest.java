...
public class MeshShaderTest extends GdxTestKotlin {
    ...
    public void create() {
        ...
        meshCustomVA.setVertices(new float[]{-0.5f, -0.5f, 0, Color.WHITE_FLOAT_BITS, toSingleFloat(0, 1), 0.5f, -0.5f, 0, Color.WHITE_FLOAT_BITS, toSingleFloat(1, 1), 0.5f, 0.5f, 0, Color.WHITE_FLOAT_BITS, toSingleFloat(1, 0), -0.5f, 0.5f, 0, Color.WHITE_FLOAT_BITS, toSingleFloat(0, 0)});
