...
public class FullscreenTest extends GdxTestK {
    SpriteBatch batch;
    Texture tex;
    ...
    public void render() {
        ...
        batch.begin();
        batch.setColor(Gdx.input.getX() < Gdx.graphics.getSafeInsetLeft() || Gdx.input.getX() + tex.getWidth() > Gdx.graphics.getWidth() - Gdx.graphics.getSafeInsetRight() ? Color.RED : Color.WHITE);
