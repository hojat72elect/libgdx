...
public class DisplayModeTest extends GdxTestK {
    ...
    boolean isDisplayModeEqual(DisplayMode a, DisplayMode b) {
        ...
        boolean equal = a.bitsPerPixel == b.bitsPerPixel && a.height == b.height && a.refreshRate == b.refreshRate && a.width == b.width;
        return equal;
    }
