...
public abstract class BaseShadowSystem implements ShadowSystem, Disposable {
    ...
    public BaseShadowSystem() {
        this(new AABBNearFarAnalyzer(), new FixedShadowMapAllocator(FixedShadowMapAllocator.QUALITY_MED, FixedShadowMapAllocator.QUANTITY_MAP_MED), new BoundingSphereDirectionalAnalyzer(), new FrustumLightFilter());
    }
    ...
    public void addLight(PointLight point) {
        addLight(point, EnumSet.of(CubemapSide.PositiveX, CubemapSide.NegativeX, CubemapSide.PositiveY, CubemapSide.NegativeY, CubemapSide.PositiveZ, CubemapSide.NegativeZ));
    }
