...
public class KTXProcessor {
    ...
    final static byte[] HEADER_MAGIC = {(byte) 0x0AB, (byte) 0x04B, (byte) 0x054, (byte) 0x058, (byte) 0x020, (byte) 0x031, (byte) 0x031, (byte) 0x0BB, (byte) 0x00D, (byte) 0x00A, (byte) 0x01A, (byte) 0x00A};
        ...
        public void create() {
            ...
            for (int face = 0; face < nFaces; face++) {
                ...
                for (int level = 0; level < nLevels; level++) {
                    ...
                    if (isAlphaAtlas) {
                        if (levelPixmap == null)
                            levelPixmap = ETC1.decodeImage(levelETCData, Format.RGB888);
