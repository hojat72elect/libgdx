...
public class FlameMain extends JFrame implements AssetErrorListener {
    public static final String DEFAULT_FONT = "default.fnt", DEFAULT_BILLBOARD_PARTICLE = "pre_particle.png", DEFAULT_MODEL_PARTICLE = "monkey.g3db", // DEFAULT_PFX = "default.pfx",
    ...
    public ControllerType getControllerType() {
        ...
        if (controller.renderer instanceof BillboardRenderer) type = ControllerType.Billboard;
    ...
    protected void addInfluencer(Class<Influencer> type, ParticleController controller) {
        ...
        try {
            ...
            if (ColorInfluencer.class.isAssignableFrom(type)) {
                ...
                ParticleControllerInfluencer currentInfluencer = controller.findInfluencer(com.badlogic.gdx.graphics.g3d.particles.influencers.ParticleControllerInfluencer.class);
                if (currentInfluencer != null) {
