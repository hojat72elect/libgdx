...
public class Pass2Shader extends DefaultShader {
    ...
    public Pass2Shader(final Renderable renderable, final Config config, final String prefix, final String vertexShader, final String fragmentShader) {
    ...
    public static String createPrefix(final Renderable renderable, final Config config) {
        ...
        if (dir) prefix += "#define directionalLight\n";
    ...
    public void render(Renderable renderable, Attributes combinedAttributes) {
        if (shadowSystem.isFirstCallPass2()) combinedAttributes.remove(BlendingAttribute.Type);
        else combinedAttributes.set(blend);
