...
public class SimpleDecalTest extends GdxTestKotlin {
    ...
    public void create() {
        ...
        TextureRegion[] textures = {new TextureRegion(new Texture(Gdx.files.internal("data/egg.png"))), new TextureRegion(new Texture(Gdx.files.internal("data/sys.png"))), new TextureRegion(new Texture(Gdx.files.internal("data/badlogic.jpg")))};
