...
public class Octree<T> {
    ...
    /**
     * Get the nodes as bounding boxes; it's useful for debug purposes.
     */
    ...
    public interface Collider<T> {
         ...
         *
         * @return true, if the aabb and geometry are intersecting.
         */
         ...
         *
         * @return true if the frustum and geometry are intersecting.
         */
         ...
         *
         * @return the distance between ray and geometry.
         */
