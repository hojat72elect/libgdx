...
public class DynamicsInfluencerPanel extends InfluencerPanel<DynamicsInfluencer> {
    ...
    private static final String VEL_TYPE_ROTATIONAL_2D = "Angular Velocity 2D", VEL_TYPE_ROTATIONAL_3D = "Angular Velocity 3D", VEL_TYPE_CENTRIPETAL = "Centripetal", VEL_TYPE_TANGENTIAL = "Tangential", VEL_TYPE_POLAR = "Polar", VEL_TYPE_BROWNIAN = "Brownian", VEL_TYPE_FACE = "Face";
    ...
    protected void deleteVelocity() {
        ...
        ParticleController controller = editor.getEmitter();
        DynamicsInfluencer influencer = controller.findInfluencer(com.badlogic.gdx.graphics.g3d.particles.influencers.DynamicsInfluencer.class);
