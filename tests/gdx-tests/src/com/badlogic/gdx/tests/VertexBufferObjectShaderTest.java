...
public class VertexBufferObjectShaderTest extends GdxTestKotlin {
    Texture texture;
    ...
    public void create() {
        ...
        if (Gdx.gl30 != null) {
            vbo = new VertexBufferObjectWithVAO(true, 3, new VertexAttribute(VertexAttributes.Usage.Position, 2, "a_position"), new VertexAttribute(VertexAttributes.Usage.TextureCoordinates, 2, "a_texCoords"), new VertexAttribute(VertexAttributes.Usage.ColorPacked, 4, "a_color"));
        } else {
