...
public class FilterPerformanceTest extends GdxTestKotlin {
    SpriteBatch batch;
    Sprite sprite;
    Sprite sprite2;
    TextureAtlas atlas;
    ...
    int mode = 0;
    String modeString = "";
    int[] filters = {GL20.GL_NEAREST, GL20.GL_LINEAR, GL20.GL_NEAREST_MIPMAP_NEAREST, GL20.GL_LINEAR_MIPMAP_NEAREST, GL20.GL_LINEAR_MIPMAP_LINEAR};
    ...
    public void renderSprite() {
        ...
        if (mode % 2 == 0) sprite2.draw(batch);
