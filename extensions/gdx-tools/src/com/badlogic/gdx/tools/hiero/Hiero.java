...
public class Hiero extends JFrame {
    ...
    void open(File file) {
        ...
        if (settings.getRenderType() == RenderType.Native.ordinal()) nativeRadio.setSelected(true);
    ...
    private class EffectPanel extends JPanel {
        ...
        GridBagConstraints constrains = new GridBagConstraints(0, -1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0);
        ...
        public void updateValues() {
            ...
            for (Object value : values)
                addValue((ConfigurableEffect.Value) value);
        }
        ...
        public void addValue(final Value value) {
            ...
            else valueValueLabel.setText(value.toString());
