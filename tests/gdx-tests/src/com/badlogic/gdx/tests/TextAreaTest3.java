...
public class TextAreaTest3 extends GdxTestKotlin {
    private Stage stage;
    private Skin skin;
    TextField textField;
    TextArea textArea;
    ...
    public void create() {
        ...
        styleLSans15.font = new BitmapFont(Gdx.files.internal("data/lsans-15.fnt"), Gdx.files.internal("data/lsans-15_00.png"), false);
    ...
    private void printMetrics(String name, BitmapFont font) {
        ...
        Gdx.app.log(name, "line height = " + data.lineHeight + ", text height = " + textHeight + ", text field height = " + textFieldHeight + ", cap height = " + data.capHeight + ", descent = " + data.descent);
    }
